...
userType: v.union(v.literal("lawyer"), v.literal("end-user"), v.literal("admin")),
...
type: v.union(v.literal("consultation"), v.literal("follow-up"), v.literal("court-prep")),
...
authorId: v.optional(v.id("users")), // Changed to proper ID reference
